package String::Format::Compiled::Mouse::Sequence;

# uses #########################################################################    
use Mouse;

# types ########################################################################
use MouseX::Types::Mouse            qw~Str HashRef Int CodeRef Bool Undef~;
use String::Format::Compiled::Mouse::Types qw~Char~;
