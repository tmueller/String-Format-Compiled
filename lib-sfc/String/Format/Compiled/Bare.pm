package String::Format::Compiled::Bare;

# uses #########################################################################    
use strict;
use warnings;

use String::Format::Compiled::Bare::Sequence;
use String::Format::Compiled::Bare::String;
...
sub _build_compiled_format {
    ...
    while ($format =~ s/$regex//) {
        push @parts, String::Format::Compiled::Bare::String::->new(value => $1) if ($1);
        
        my $sequence = String::Format::Compiled::Bare::Sequence::->new(
            value       => $2,
    ...
    push @parts, String::Format::Compiled::Bare::String::->new(value => $format) if ($format);    
