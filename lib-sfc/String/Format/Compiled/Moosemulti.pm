package String::Format::Compiled::Moosemulti;
...
use String::Format::Compiled::Moosemulti::Sequence;
use String::Format::Compiled::Moosemulti::String;
...
method _build_compiled_format {
    ...
    while ($format =~ s/$regex//) {
        push @parts, String::Format::Compiled::Moosemulti::String::->new(value => $1) if ($1);
        
        my $sequence = String::Format::Compiled::Moosemulti::Sequence::->new(
            value       => $2,
    ...
    push @parts, String::Format::Compiled::Moosemulti::String::->new(value => $format) if ($format);    
