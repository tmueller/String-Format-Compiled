package String::Format::Compiled::Moose;
...
use String::Format::Compiled::Moose::Sequence;
use String::Format::Compiled::Moose::String;
...
sub _build_compiled_format {
    ...
    while ($format =~ s/$regex//) {
        push @parts, String::Format::Compiled::Moose::String::->new(value => $1) if ($1);
        
        my $sequence = String::Format::Compiled::Moose::Sequence::->new(
            value       => $2,
    ...
    push @parts, String::Format::Compiled::Moose::String::->new(value => $format) if ($format);    
