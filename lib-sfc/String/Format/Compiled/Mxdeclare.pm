...
class String::Format::Compiled::Mxdeclare {
...
use String::Format::Compiled::Mxdeclare::Sequence;
use String::Format::Compiled::Mxdeclare::String;
...
method _build_compiled_format {
    ...
    while ($format =~ s/$regex//) {
        push @parts, String::Format::Compiled::Mxdeclare::String::->new(value => $1) if ($1);
        
        my $sequence = String::Format::Compiled::Mxdeclare::Sequence::->new(
            value       => $2,
    ...
    push @parts, String::Format::Compiled::Mxdeclare::String::->new(value => $format) if ($format);    
