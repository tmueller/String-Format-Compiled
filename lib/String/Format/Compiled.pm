...
# ABSTRACT: sprintf-style formatting with arbitrary format definitions
...
=constructor new($format)

=constructor new(format => $format)

=attr format

String, that contains the formatdefinition
...
renders formatdefinition for the given Args
